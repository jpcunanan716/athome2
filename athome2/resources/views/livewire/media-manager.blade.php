    ...
    <form wire:submit.prevent="save" class="w-full max-w-2xl mx-auto">
        ...
        <div wire:loading wire:target="images" class="mt-4 text-center">
            <div class="flex items-center justify-center">
                ...
                <span class="ml-2 text-fuchsia-500">Processing images...</span>
            </div>
        </div>
        ...
        <div class="flex justify-center mt-6">
            <button 
                type="submit" 
                class="px-6 py-2 bg-fuchsia-500 text-white rounded-md hover:bg-fuchsia-600 disabled:bg-fuchsia-300 disabled:cursor-not-allowed shadow-sm"
                wire:loading.attr="disabled"
                wire:loading.class="bg-fuchsia-300"
            >
